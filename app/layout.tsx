...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://ravidhulipala.com/linkedin-preview.jpg",
        secureUrl: "https://ravidhulipala.com/linkedin-preview.jpg",
        type: "image/jpeg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: ["https://ravidhulipala.com/linkedin-preview.jpg"],
  },
  robots: {
    index: true,
    follow: true,
